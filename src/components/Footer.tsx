...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-superlens-navy text-white">
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          <div className="lg:col-span-2">
            <Logo className="mb-6" />
            <p className="text-blue-200 mb-4 max-w-xs">
              SuperLens is an AI-powered decision intelligence platform that helps businesses make smarter decisions faster.
            </p>
        ...
        <div className="border-t border-blue-900 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-blue-300 text-sm mb-4 md:mb-0">
              © {currentYear} SuperLens. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link to="/privacy" className="text-blue-300 hover:text-white text-sm">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-blue-300 hover:text-white text-sm">
                Terms of Service
              </Link>
              <Link to="/security" className="text-blue-300 hover:text-white text-sm">
                Security
              </Link>
            </div>
          </div>
